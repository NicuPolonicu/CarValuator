\section{Colectarea și pregătirea datelor}
\label{sec:implementation-data}

Implementarea componentei de date urmărește un flux complet, de la colectarea anunțurilor până la obținerea unui set coerent pentru antrenare. Subsecțiunile următoare descriu sursele, particularitățile scraperelor, schema comună, normalizarea, deduplicarea și verificările efectuate înaintea modelării.

\subsection{Sursele de date}
...
\subsection{Scraping pentru Autovit}
...
\subsection{Scraping pentru mobile.de}
...
\subsection{Schema datelor brute}
...
\subsection{Analiza exploratorie}
\label{sec:data-eda}
...
\subsection{Pregătirea pentru antrenare}
