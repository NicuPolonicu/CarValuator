...
\begin{itemize}
    ...
    \item selecția caracteristicilor semnificative folosind corelație Pearson pentru variabile numerice și teste de tip chi-pătrat cu efect Cramer pentru variabile categorice;
...
Capitolul \ref{chapter:requirements} prezintă analiza utilizatorilor și cerințele aplicației. Capitolul \ref{chapter:market} discută piața, soluțiile existente pe \autovit\ și \mobilede, precum și fundamentarea teoretică. Capitolul \ref{chapter:application} descrie proiectarea sistemului prin arhitectură modulară, cazuri de utilizare, diagramă de execuție și schema bazei de date. Capitolul \ref{chapter:implementation} explică implementarea scraping-ului, pregătirea datelor, modelele ML, backend-ul, frontend-ul, securitatea și deployment-ul. Capitolul \ref{chapter:testing} prezintă scenariile de test, rezultatele experimentale și comparația cu indicatorii platformelor. Capitolul \ref{chapter:conclusions} sintetizează dificultățile întâlnite, limitele curente și direcțiile viitoare.
