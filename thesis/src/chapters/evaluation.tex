...
Evaluarea experimentală reunește măsurarea performanței modelelor, analiza erorilor și verificarea comportamentului aplicației pe anunțuri reale. Rezultatele sunt interpretate atât statistic, cât și prin comparație cu indicatorii oferiți de platformele studiate.

\subsection{Configurația experimentului}
\label{sec:evaluation-setup}

Evaluarea finală a fost realizată pe setul combinat extins, format din 9633 de anunțuri. După curățarea finală aplicată de pipeline-ul de antrenare, au rămas 9367 exemple. Împărțirea train-test a folosit 80\% pentru antrenare și 20\% pentru testare, rezultând 7493 rânduri de antrenare și 1874 rânduri de test.
...
\subsection{Rezultatele modelelor}
...
\subsection{Analiza predicțiilor}
...
\subsection{Corelații și interpretabilitate}
...
\subsection{Testare prin aplicație}
...
\subsection{Comparație cu indicatorii platformelor}
...
\subsection{Calitatea setului de date}
...
\subsection{Acuratețe și utilitate practică}
...
Fluxul experimental este reproductibil prin comenzile din \labelindexref{Anexa}{appendix:commands}. Datele brute sunt salvate în JSONL, rapoartele de normalizare sunt salvate în JSON, iar antrenarea produce fișiere CSV cu predicțiile fiecărui model. Această structură permite refacerea graficelor și verificarea deciziilor de filtrare.
