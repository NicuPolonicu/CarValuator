\chapter{Fundamentare teoretică și lucrări conexe}
\label{chapter:background}

\section{Evaluarea prețurilor ca problemă de regresie}
...
\section{Transformarea logaritmică a prețului}
...
\section{Selecția caracteristicilor}
...
Pentru variabile numerice se folosește corelația Pearson, o măsură clasică a asocierii liniare dintre două variabile \cite{pearson1895correlation}. Pentru variabile categorice, ținta numerică este discretizată în intervale, apoi se aplică un test de tip chi-pătrat. Mărimea efectului este aproximată prin Cramér V, o măsură potrivită pentru tabele de contingență \cite{cramer1946mathematical}.
...
\section{Web scraping și considerații etice}
...
Pentru deployment a fost pregătită o configurație Render, deoarece serviciile web Render pot porni aplicații Python care se leagă la portul furnizat prin variabila de mediu \texttt{PORT} \cite{render_docs}. Template-ul LaTeX al lucrării provine din repository-ul public \texttt{cs-pub-ro/templates} \cite{cs_pub_templates}.
